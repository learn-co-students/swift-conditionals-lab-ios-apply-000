...
func isForceWith (strong:String) -> Bool {
    ...
    else if strong == "Anakin" {
        
        return true
    }
    
    else if strong == "Obi Wan" {
...
*/
func bankAccount (myAccount:Int, secondAccount:Int) -> String {
    ...
    if secondAccount >= 10 {
        ...
        return ("Your funds are now \(myAccount)")
    }
    else {
    
    return ("You can't not withdraw")
    }
}
