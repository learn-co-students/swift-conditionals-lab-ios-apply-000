...
*/
func isGreater(firstArgument: Int, secondArgument: Int) -> Bool {
...
*/
func isForceWith(nameOfForces: String) -> Bool {
    if nameOfForces == "Luke" {
        return true
    } else if nameOfForces == "Leia" {
        return true
    } else if nameOfForces == "Anakin" {
        return true
    } else if nameOfForces == "Obi Wan" {
        return true
    } else if nameOfForces == "Yoda" {
        return true
    } else if nameOfForces == "Vader" {
        return true
    } else {
        return false
    }
