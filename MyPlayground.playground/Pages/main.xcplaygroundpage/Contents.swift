...
isGreater(number1: 4, number2: 3)
isGreater(number1: 3, number2: 5)
...
func isForceWith(_ name : String) -> Bool {
    ...
    let array = ["Luke", "Leia", "Anakin", "Obi Wan", "Yoda", "Vader"]
...
func transferFunds(myBalance : Int, theirBalance : Int) -> (myBalance : Int, theirBalance : Int) {


  if theirBalance >= 10 {

    return (myBalance+10,  theirBalance-10)

  } else {
    print("They only have $\(theirBalance) left")
...
let answer = transferFunds(myBalance: mybal, theirBalance: theirbal)

print("\(answer.myBalance)")
print("\(answer.theirBalance)")
