...
print("y * b <= a - ",  String(y * b <= a))


/*: Question 4
 ### 4. Print the inverse of a greater than or equal to b
 */
print("a>=b inverse ", String(!(a>=b)))
 ...
 */
func isGreater(_ argOne:Int, _ argTwo:Int) -> Bool
{
    if (argOne > argTwo)
    {
 ...
 */
func isForceWith(_ argOne: String) -> Bool
{
    if (argOne=="Luke" || argOne=="Leia" || argOne=="Anakin" || argOne=="Obi Wan" ||  argOne=="Yoda" ||   argOne=="Vader")
    {
        return true
    }
    else{
 ...
 */
func bank( myAcc:Int, targetAccount:Int)
{
