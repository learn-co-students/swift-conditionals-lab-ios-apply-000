...
*/
func isGreater(brandonSanderson: Int, patrickRothfuss: Int) -> Bool {
    if brandonSanderson > patrickRothfuss {
        return true
    } else {
        return false
}
...
*/
    func passGo(personalAccount: Int, businessAccount: Int){
