...
func stackPaper(myAccount: Double, otherAccount: Double) {
    if otherAccount >= 10 {
        // subtract 10 from it and add 10 to mine
        myAccount + 10
        otherAccount - 10
        print(myAccount)
    }
...
stackPaper(45.0, otherAccount: 23.0)
stackPaper(123.0, otherAccount: 435.9)
